...
Insert into eg_action(id,name,url,parentmodule,ordernumber,displayname,enabled,contextroot,application) values(nextval('SEQ_EG_ACTION'),'Search and View-Asset','/asset/search/view',(select id from eg_module where name='Asset Transactions' and parentmodule=(select id from eg_module where name='Asset Management' and parentmodule is null)),2,'Search and View-Asset',true,'egassets',(select id from eg_module where name='Asset Management' and parentmodule is null));
