...
public class SewerageBillable extends AbstractBillable implements Billable {
    ...
    public EgDemand getCurrentDemand() {
        if(getSewerageApplicationDetails()!=null && getSewerageApplicationDetails().getConnection()!=null)
            return getSewerageApplicationDetails().getConnection().getDemand();
    ...
    public String getDescription() {
        if (null != getSewerageApplicationDetails().getConnection().getDhscNumber())
            return "Sewerage connection H.S.C No: " + getSewerageApplicationDetails().getConnection().getDhscNumber();
        else
