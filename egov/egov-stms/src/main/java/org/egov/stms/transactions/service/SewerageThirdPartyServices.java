...
public class SewerageThirdPartyServices {
    ...
    public HashMap<String, BigDecimal> getWaterTaxDueAndCurrentTax(final String assessmentNo, final HttpServletRequest request) {
        ...
        result.put("WATERTAXDUE", waterTaxInfo.get("totalTaxDue") == null ? BigDecimal.ZERO : new BigDecimal(
